...
class WeatherRAMDepthTrainer:
    def __init__(
        ...
        self.val_loaders: Optional[List[DataLoader]] = val_dataloaders
        self.vis_loaders: Optional[List[DataLoader]] = vis_dataloaders
    ...
    def _train_step_callback(self):
        ...
        if self.backup_period > 0 and self.effective_iter % self.backup_period == 0:
            self.save_checkpoint(
        ...
        # Validation
        if self.val_period > 0 and self.effective_iter % self.val_period == 0:
